...
public class SimulationCV extends Application {
    // JAVA FX
    @Override
...
//------------------------------------------------------------
    ...
    // 1. DONE
    // Generate a matrix of Actors
    Actor[][] initWorld() {
        double[] distribtuion = {0.45, 0.45, 0.10};
        ...
        for (int indexRow = 0; indexRow < world.length; indexRow ++) {
            for (int indexColumn = 0; indexColumn < world.length; indexColumn ++) {
                if (world[indexRow][indexColumn] == Actor.NONE) {
                    ...
                    indexRowListNones++;
                    /*----------------------------------------
                    empty = new int[]{indexRow, indexColumn};
